---
name: write_like_human
description: |
  去除文本中的 AI 生成痕迹。适用于编辑或审阅文本，使其听起来更自然、更像人类书写。检测并修复以下模式：夸大的象征意义、宣传性语言、以 -ing 结尾的肤浅分析、模糊的归因、破折号过度使用、三段式法则、AI 词汇、否定式排比、过多的连接性短语、同义词堆砌、抽象名词滥用等。
---
...
6. **拒绝废话** - 不要用连续的近义词，不要反复说同一件事，不要开头总结
...
**问题：** 使用连续两个并列的相近词汇，删掉其中一个对表意没有任何影响。

**改写前：**
> 这种方法更能被**承认和肯定**。我们需要**支持和拥护**这项决议。

**改写后：**
> 这种方法更能被肯定。我们需要支持这项决议。

---

### 14. 抽象名词后缀滥用 ("-性")

**问题：** 反复使用"XX性"，如精确性、及时性、复合性、系统性、可积累性、实质性等。

**改写前：**
> 我们要提高系统的**精确性**和**及时性**，确保数据的**完整性**。

**改写后：**
> 我们要让系统更精确、更及时，确保数据完整。

---

### 15. 程式化连接词

**问题：** 句式呆板，过度使用"首先、其次、然后、最后"或"因此"等连接词。

**改写前：**
> **首先**，我们打开文件。**其次**，我们读取内容。**最后**，我们关闭文件。**因此**，操作完成。
...
**问题：** 频繁使用括号来解释或补充，打断阅读节奏。除专业术语首字母缩写外，应尽量少用。

**改写前：**
> 这是一个重要的（对我们来说）决定（虽然很难）。
...
**问题：** 段内格式过于规整，例如"开头总结句-中间具体论述-段末总结句"，或开头用几个字总结再写内容。

**改写前：**
> **核心优势：** 本产品具有三大核心优势……（此处省略论述）……综上所述，这些优势使其脱颖而出。
...
**规范：** 避免模板化的总-分-总或固定三段式。不用"第X点""小结"等分隔标识。建议采用标准四层标题结构（1, 1.1, 1.1.1）。
...
**规范：** 论文一般用"本文"、"本研究"、“本系统”、“本项目”等来指代自己的论文，而不是用"我"、"我们"等。
...
### 32. 规则覆盖
用户提出“论文”相关的撰写与修改需求时，需要适当放弃“个性与灵魂”，而关注“逻辑与结构”上。
---
...
| **精炼度** | 是否去除了同义词堆砌和废话？<br>10 分：无冗余；1 分：大量废话 | /10 |
| **总分** |  | **/50** |
...
**改写前（AI 味道）：**
> 新的软件更新作为公司致力于创新的证明。此外，它提供了无缝、直观和强大的用户体验——确保用户能够高效地完成目标。这不仅仅是一次更新，而是我们思考生产力方式的革命。行业专家认为这将对整个行业产生持久影响，彰显了公司在不断演变的技术格局中的关键作用。**精确性**和**及时性**得到了**保证和确保**。
...
- 删除了"精确性和及时性"（"-性"滥用）和"保证和确保"（同义词堆砌）
- 添加了具体功能和具体反馈
