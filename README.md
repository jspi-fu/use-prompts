...
- **[Handbook.md](论文撰写/Handbook.md)** - 论文撰写手册
- **[README.md](论文撰写/README.md)** - 论文撰写指南
- **prompts**
  - **[文献查找.md](论文撰写/prompts/文献查找.md)** - 详细全面的文献调研方法
  - **[论文剖析.md](论文撰写/prompts/论文剖析.md)** - 复杂学术论文直观易懂的解释
  - **[论文绘图.md](论文撰写/prompts/论文绘图.md)** - Nano-Banana Pro论文绘图完整教程
  - **[表达润色（中文论文）.md](论文撰写/prompts/表达润色（中文论文）.md)** - 中文论文表达润色技巧
  - **[中转中.md](论文撰写/prompts/中转中.md)** - 论文中转处理指南
- **skills**
  - **AI-research-SKILLs** - AI研究技能集合
...
- **[公众号封面.md](日常使用/公众号封面生成.md)** - 根据标题/类型匹配风格，生成公众号HTML封面代码
- **[对话式播客生成.md](日常使用/对话式播客生成.md)** - 对话式播客内容呈现指南，双角色交替，提升信息传递效果
- **[根除AI味.md](日常使用/根除AI味.md)** - 去除文本中的 AI 生成痕迹，使其听起来更自然、更像人类书写
